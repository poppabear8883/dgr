<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header color-red">Roofing <small>#1 RATED ROOFING COMPANY IN THE MIAMI VALLEY</small></h2>
    </div>
    <div class="col-md-6">
        <p>
    ...
    <div class="col-md-6">
        <img class="img-responsive" src="images/header-shake.jpg" alt="" width="350px">
    </div>
    ...
    <div class="col-md-10">
        ...
        <div class="col-md-6">
            <img class="img-responsive" src="images/certainteed.png" alt="">
        </div>
        <div class="col-md-6">
            <img class="img-responsive" src="images/certainteed-assorted-colors.jpeg" alt="">
        </div>
    </div>
</div>
